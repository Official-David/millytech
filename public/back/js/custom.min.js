var Griya = function () {
    ...
    return {
        ...
        load: function () {
            ...
            if ('undefined' != typeof (niceSelect)) { jQuery(".default-select").length > 0 && jQuery(".default-select").niceSelect() }
        },
        resize: function () {
            t()
        },
...
jQuery(document).ready(function () {
    $('[data-bs-toggle="popover"]').popover(), Griya.init()
}), jQuery(window).on("load", function () {
    "use strict";
    Griya.load(), setTimeout(function () {
        Griya.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function () {
    "use strict";
    Griya.resize(), setTimeout(function () {
        Griya.handleMenuPosition()
    }, 1e3)
});
