            ...
            <div class="card-body">
                <form action="{{route('user.trades.place')}}" method="POST" id="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group pt-5">
                        ...
                        <select name="giftcard" id="giftcard" class="form-select form-select-lg form-control wide fs-12">
                    ...
                    <div class="form-group pt-5">
                        ...
                        <select name="currency" id="currencies" class="form-select form-select-sm form-control form-control-sm wide fs-12" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="amount" class="form-control fs-12">
                        <x-error key="amount" />
                    ...
                    <div class="form-group">
                        ...
                        <label for="upload" class="btn btn-outline-primary btn-sm">Upload <i class="fa fa-upload"></i></label>
