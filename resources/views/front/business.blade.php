            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-5 col-lg-5 col-md-12 order-1 order-lg-0">
                    <div class="testimonial-tab-slider-wrap mt-5">
                        <h1 class="fw-bold text-white display-5">Millytech Business</h1>
                        <p>Discover better and smarter ways to increase the visibility of your business or company. Join other smart merchants to create  business giftcards and take your marketing to a whole new level.                            .</p>
                        <hr>
                        <div class="tab-content testimonial-tab-content text-white-80" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="testimonial-tab-1" role="tabpanel">
                                <blockquote class="blockquote">
                                    <em>"Create a personalized gift card for your loyal customers and make them feel special. Remember that happy customers mean more sales."</em>
                                </blockquote>
                            </div>
                            </div>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label small" for="flexCheckChecked">
                                            Yes, I'd like to receive occasional marketing emails from us. You have the
