            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <p class="lead">Experiencing any difficulty? Feel free to contact us we are always here for you.</p>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
                        <div class="contact-us-promo p-5 bg-white rounded-custom custom-shadow text-center d-flex flex-column h-100">
                            ...
                            <div class="contact-promo-info mb-4">
                                <h5>Email Us</h5>
                                <p>Simply drop us an email at <strong>support@millytechtrade.com</strong>
                                    and you'll receive a reply within 24 hours</p>
                            </div>
                            <a href="mailto:support@millytechtrade.com" class="btn btn-primary mt-auto">Email Us</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
                        <div class="contact-us-promo p-5 bg-white rounded-custom custom-shadow text-center d-flex flex-column h-100">
                            ...
                            <a href="tel:+234 906 645 0545" class="btn btn-link mt-auto">+234 906 645 0545</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-lg-between align-items-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="section-heading">
                            <h2>Talk to Our Sales & Marketing and Technical Team</h2>
                            <p>We usually respomd to emails within 24hours.</p>
                        </div>
